...
This project contains a corpus study and two behavioral experiments. The corpus study is the first large-scale investigation on child Mandarin passives, investigating CHILDES (MacWhinney 2000) corpora from 1,182 children and their caretakers. The  experiments  investigate 3- to 6-year-olds’ comprehension of Mandarin long and short passives and test the predictions of the Intervention Hypothesis (e.g., Friedmann et al. 2009) based on the (featural) Relativized Minimality (e.g., Rizzi 1990, 2001, 2013), with respect to the role of three linguistic features in Mandarin, namely Animacy, Number, and Shape.

Project outputs:
* __Liu, Minqi__, [Mateu, Victoria](https://www.victoriamateu.com), and [Hyams, Nina](https://linguistics.ucla.edu/person/nina-hyams/). 2025. <a href="https://www.tandfonline.com/doi/full/10.1080/10489223.2025.2528738" target="_new">Number, shape, and intervention effects in child Mandarin passives</a>. _Language Acquisition_, Published online on Oct 2, 2025. 
* __Liu, Minqi__, [Mateu, Victoria](https://www.victoriamateu.com), and [Hyams, Nina](https://linguistics.ucla.edu/person/nina-hyams/). 2024. <a href="https://www.mdpi.com/2226-471X/9/7/236" target="_new">On the Representation of Implicit Arguments in Child Grammar: Short Passives in Mandarin and English</a>. _Languages_ 9(7), 236. 
...
Fundings:
* [Doctoral Dissertation Research Improvement Grant ($15,001)](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2146647&HistoricalAwards=false) by the National Science Foundation (NSF) 
